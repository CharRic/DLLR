...
def main_worker_stage1(args, log_s1_name):
    ...
    print("==> Load dataset.")
    dataset_rgb_masked = get_data(args.dataset, args.data_dir, mode=args.mode, modal="rgb", suffix="_mask")
    ...
    for epoch in range(args.epochs):
        with torch.no_grad():
            ...
            rerank_dist_rgb = compute_jaccard_distance(features_rgb_masked, k1=args.k1, k2=args.k2)
