...
class SYSU_MM01_RGB(BaseImageDataset):
    dataset_dir = "sysu"

    def __init__(self, root='', mode='all', verbose=True, ncl=1, suffix="", **kwargs):
        super(SYSU_MM01_RGB, self).__init__()

        self.dataset_dir = osp.join(root, self.dataset_dir + suffix)
        ...
        self.train = self._process_dir(self.train_id, self.rgb_cams)
